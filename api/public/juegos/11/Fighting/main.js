window.onload = () => {
    ...
    imagen = new Image()
    imagen.src = "/juegos/12/nuevoJuego/link.png"
    ...
    function Enemigo(x, y, vida = 1, nombre) {
        ...
        Enemigo.prototype.pintarEnemigo = function () {
            ...
            if (this.estado === 'muerto') {
                ...
                this.imagen.src = "/juegos/12/nuevoJuego/enemyDeath.png"
    ...
    imagen = new Image()
    imagen.src = "/juegos/12/nuevoJuego/enemies.png"
    ...
    imagen = new Image()
    imagen.src = "/juegos/12/nuevoJuego/ZeldaSpriteOldMan.png"
    ...
    imagen = new Image()
    imagen.src = "/juegos/12/nuevoJuego/tiles-overworld2.png"
    ...
    function drawHUD() {
        let hud
        hud = new Image()
        hud.src = "/juegos/12/nuevoJuego/hud.png"
        ctx.save()
        ctx.globalAlpha = 1;
        ctx.fillStyle = 'black'
    ...
    function Item(nombre_, valor_, x_, y_, tamañoX_, tamañoY_) {
        ...
        this.imagen = new Image()
        this.imagen.src = '/juegos/12/nuevoJuego/items.png'
    ...
    function healthController() {
        let items = new Image()
        items.src = '/juegos/12/nuevoJuego/items.png'
        let x = 0
        let y = 0
        //8 X 8
        //434 X 43
