const idiomas = {
  "es": {
    ...
    landingPage: {
      cabecera: {
        subtitulo: "Sube tu videojuego, y disfruta jugando y opinando los de tus compañeros."
      },
      favoritos: {
      ...
      ranking: {
        titulo: "Ranking Mejores Juegos",
        subtitulo: "Aquí se muestran los mejores juegos de la página según su valoración.",
        puesto: "PUESTO"
      },
      totales: {
        titulo: "Número Total de Usuarios, Opiniones y Juegos",
        usuarios: "Usuarios",
        opiniones: "Opiniones",
        juegos: "Juegos"
      },
    ...
    perfil: {
      ...
      videojuego: {
        ...
        boton: "Subir Videojuego",
        quitarFicheros: "Quitar Ficheros",
        guardarCambios: "Guardar Cambios",
        switch: "Elige ficheros o carpetas",
        carpeta: "Carpeta",
        fichero: "Ficheros",
      },
  ...
  "gb": {
    ...
    landingPage: {
      cabecera: {
        subtitulo: "Upload your game, and enjoy playing and commenting on your classmates' games."
      },
      favoritos: {
      ...
      ranking: {
        titulo: "Best Games Ranking",
        subtitulo: "Here are the best games on the page according to their rating.",
        puesto: "RANK"
      },
      totales: {
        titulo: "Total Number of Users, Opinions and Games",
        usuarios: "Users",
        opiniones: "Opinions",
        juegos: "Games"
      },
    ...
    perfil: {
      ...
      videojuego: {
        ...
        boton: "Upload Game",
        quitarFicheros: "Remove Files",
        guardarCambios: "Save Changes",
        switch: "Choose files or folders",
        carpeta: "Folder",
        fichero: "Files",
      },
      borrarCuenta: "Delete Account",
      subirVideojuego: "Upload Game",
